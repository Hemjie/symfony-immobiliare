...
/**
 * Un service est une classe dont l'objectif est d'être réutilisable. Elle sert aussi à organiser son code
 */
...
class SuperCart
{
    ...
    /**
     * On peut récupérer d'autres services dans le constructeur d'un service
     */
    ...
    /**
     * Permet ajout d'un item dans le panier
     */
    public function addItem($item) {
        //Retourne le tableau de produits présents en session OU un tableau vide
